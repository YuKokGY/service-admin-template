...
(
    ...
    PRIMARY KEY (id),
    UNIQUE KEY md5_del (md5, is_delete)
) ENGINE = InnoDB
...
(
    ...
    is_delete   bit                            DEFAULT FALSE,
    PRIMARY KEY (id),
    UNIQUE KEY name_del (name, is_delete)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci;
...
(
    ...
    is_delete   bit                       DEFAULT FALSE,
    PRIMARY KEY (id),
    UNIQUE KEY username_del (username, is_delete),
    UNIQUE KEY email_del (email, is_delete)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci;
...
INSERT INTO t_group(id, name, info, level)
